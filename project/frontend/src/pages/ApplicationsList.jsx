            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex space-x-4">
                    ...
                    <div className="relative">
                        <select
                            className="appearance-none pl-4 pr-10 py-2 border rounded-full bg-white focus:ring-2 focus:ring-blue-100 outline-none cursor-pointer shadow-sm text-sm"
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="pl-10 pr-4 py-2 border rounded-full bg-white focus:ring-2 focus:ring-blue-100 outline-none w-64 shadow-sm"
                            value={searchQuery}
                                    ...
                                    <div className="flex space-x-2 justify-end">
                                        ...
                                        {user?.role === 'manager' && (
                                            <>
                                                ...
                                                {/* Edit (Manager sees ALL edit buttons) */}
                                                <Link
                                                ...
                                                {/* Delete (Manager sees ALL delete buttons) */}
                                                <button
